import VehiclesData.processVehiclesData
...
object Main {
  def createContext(projectID: String, bigQueryDataset: String, windowInterval: Int, slidingInterval: Int): StreamingContext = {
    ...
    processVehiclesData(crashesStream, windowInterval, slidingInterval, spark, bigQueryDataset)
    ssc
  }
